...
Since CN is not normalized, some neighbor-based metrics consider how to normalize the CN metric reasonably.

\textbf{Jaccard Coefficient (JC)}: Jaccard coefficient normalizes the size of common neighbors. It assumes higher values for pairs of nodes which share a higher proportion of common neighbors relative to total number of neighbors they have. This measure is defined as:
\begin{equation}
