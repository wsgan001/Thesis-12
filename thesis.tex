...
\title{Graphs Mining with Edge Uncertainty} % Title can't use formulae, symbols, superscripts, subscripts, greek letters, etc. all of which should be replaced with word substitutes
\author{Chi Zhang}
